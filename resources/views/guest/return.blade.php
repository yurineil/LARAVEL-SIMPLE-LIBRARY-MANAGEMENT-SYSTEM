...
<div class="page-header mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('guest.borrows') }}" class="text-decoration-none">My Borrows</a></li>
            <li class="breadcrumb-item active">Return Books</li>
        </ol>
    </nav>
    <h2><i class="bi bi-arrow-down-left-square me-2"></i>Return Books</h2>
    <p class="text-muted mb-0">Fine = ₱10 × overdue days × number of books returned.</p>
</div>
...
<div class="card table-card" style="max-width: 560px;">
    <div class="card-body p-4">
        <form method="POST" action="{{ route('guest.return.process') }}">
            @csrf
