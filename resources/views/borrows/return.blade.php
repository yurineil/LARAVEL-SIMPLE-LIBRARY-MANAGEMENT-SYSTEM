...
@section('title', 'Process Return — Library System')
...
<div class="page-header">
    ...
    <h2><i class="bi bi-arrow-down-left-square me-2"></i>Process Return</h2>
    <p class="text-muted mb-0">Return all or some books. Fine = ₱10 × overdue days × number of books returned.</p>
</div>

<div class="card table-card mb-4">
    <div class="card-body">
        <h5 class="fw-bold mb-2">Borrow details</h5>
        <p class="mb-1"><strong>Student:</strong> {{ $borrow->student->name }}</p>
...
<div class="card table-card" style="max-width: 560px;">
    <div class="card-body p-4">
        <form method="POST" action="{{ route('borrows.process-return') }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <p class="small text-muted">Select the books being returned in this transaction (partial or full).</p>
